...
class CalendarList1 extends React.Component {
    constructor(props) {
        super(props)
        ...
        return (
            ...
            >
                ...
                <View style={styles.lowerbox}>
                    ...
                    <View style={[styles.abc2,{paddingTop:Platform.OS==='ios'?vh(10):vh(10)}]}>
...
export default connect(mapStateToProps, mapDispatchToProps)(CalendarList1)
